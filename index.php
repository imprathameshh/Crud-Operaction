  ...
  if($row != NULL){
    ...
    (password_verify($password, $row["password"]));
     if(password_verify($password, $row["password"])){
      ...
      echo "<script>alert('Invalid and Password'); window.location:'admin/index.php'</script>";
    }
  }
}
...
<head>
  ...
  <link rel="stylesheet" href="frontend/includes/style.css" />
  <link rel="stylesheet" href="frontend/includes/media.css" />
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 login-sec">
            ...
            <div class="pt-3">
              <p>Don't have an account? <a href="frontend/registraction-form.php">Register Here</a></p>
            </div>
